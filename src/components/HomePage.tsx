...
export default function HomePage({
  ...
  return (
    <>
      ...
      {/* Sobre Nós */}
      <section className="w-full max-w-6xl py-16 px-6 mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Nossa missão é entregar produtos de qualidade que atendam às necessidades dos nossos clientes,
              com foco em inovação e excelência.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Ser referência no mercado, reconhecida pela credibilidade, transparência e compromisso com resultados.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Ética, respeito, responsabilidade socioambiental e foco constante no desenvolvimento de pessoas.
            </p>
          </div>
        </div>
      </section>
